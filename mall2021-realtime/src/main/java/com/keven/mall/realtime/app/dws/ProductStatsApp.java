...
import com.keven.mall.realtime.bean.ProductStats;
import com.keven.mall.realtime.common.GmallConstant;
...
public class ProductStatsApp {
    ...
    public static void main(String[] args) throws Exception {
        ...
        productStatsWithTmDS.addSink(ClickHouseUtil.getSink("insert into table product_stats_2021 values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)"));
